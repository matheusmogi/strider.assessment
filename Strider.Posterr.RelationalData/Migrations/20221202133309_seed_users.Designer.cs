...
namespace Strider.Posterr.RelationalData.Migrations
{
    ...
    [Migration("20221202133309_seed_users")]
            ...
            modelBuilder.Entity("Strider.Posterr.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2022, 12, 2, 10, 33, 9, 484, DateTimeKind.Local).AddTicks(7096),
                            UserName = "User-One"
                        },
                        new
                        {
                            Id = new Guid("215b5bd8-8d90-434b-b13f-1391da1bb245"),
                            CreatedOn = new DateTime(2022, 12, 1, 10, 33, 9, 484, DateTimeKind.Local).AddTicks(7109),
                            UserName = "User-Two"
                        });
                });
